...
import "@openzeppelin/contracts/token/BEP721/extensions/IBEP721Metadata.sol";
import "@openzeppelin/contracts/token/BEP721/extensions/IBEP721Enumerable.sol";
...
contract BEP721 is Context, ERC165Storage, IBEP721, IBEP721Metadata, IBEP721Enumerable {
    ...
    */
    ...
    function _safeTransfer(address from, address to, uint256 tokenId, bytes memory _data) internal virtual {
        _transfer(from, to, tokenId);
        // 如果to是一个合约地址 则必须实现OnBEP721Received()接口
